  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-border/40 bg-card/80 px-4 backdrop-blur-md md:px-6">
      ...
      <div className="flex items-center gap-1">
        <Button variant="ghost" size="icon" onClick={toggleTheme} aria-label="Changer de thème" className="h-9 w-9 rounded-xl">
        ...
        <Button variant="ghost" size="icon" onClick={logout} aria-label="Se déconnecter" className="h-9 w-9 rounded-xl">
